...
export enum BasketballEvents {
    ...
    TotalPoints = 'basketball.game.points.total', // total game points
    ...
    TeamScores3FG = 'basketball.team.scores.3fg', // refers to n-th 3FG
    TeamShootingFoul = 'basketball.team.shooting.foul', // refers to team id
    Team2FTMade = 'basketball.team.2ft.made', // refers to team id
    TeamScoresPoints = 'basketball.team.scores.points', // refers to points
    ...
    PlayerScoresX3FG = 'basketball.player.scores.x3fg', // refers to n-th 3FG
    ...
    PlayerScoresPoints = 'basketball.player.scores.points' // refers to points
}
